    ...
    articoli: [
      {
        ...
        anteprima: 'Il nostro scopo è quello di mostrare la vasta gamma di sfumature del mondo alla luce degli eventi moderni — i ponti culturali tra i check point. Benvenuti nel numero uno.',
        testo: `<p>Il mondo non è mai stato così complicato. Né così interessante.</p>
...
<p><em>La Redazione</em></p>`,
      ...
      },
      {
        ...
        autore: null,
        titolo: 'A.A.A. Cercasi Persone da ogni "check point"',
        anteprima: 'Geo-POPlitica è un progetto aperto. Cerchiamo scrittori, fotografi, grafici, viaggiatori — chiunque abbia qualcosa da raccontare da un angolo del mondo.',
        testo: `<p>Geo-POPlitica nasce come progetto collettivo. Non abbiamo una redazione nel senso tradizionale — abbiamo una rete di persone curiose, sparse in giro per il mondo, che hanno qualcosa da raccontare.</p>
<p>Cerchiamo scrittori, fotografi, grafici, viaggiatori, cinefili, appassionati di moda, di musica, di cucina. Cerchiamo chiunque abbia uno sguardo originale su una cultura, un luogo, un fenomeno pop che merita attenzione.</p>
<p>Non è necessario essere giornalisti professionisti. È necessario avere curiosità, rispetto per le culture che si raccontano, e la capacità di trovare i ponti invece dei muri.</p>
<p>La pubblicazione è per ora a titolo gratuito — siamo all'inizio. Ma il tuo nome, il tuo lavoro, e la tua visione troveranno uno spazio curato e riconoscibile.</p>
