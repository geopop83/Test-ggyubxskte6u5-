    ...
    <div class="archivio-wrap">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;max-width:800px;margin-top:8px">
        ...
        <div>
          ...
          <p style="font-family:'Playfair Display',serif;font-size:1rem;line-height:1.8;color:var(--ink);opacity:0.75;margin-bottom:16px">Scrivi, fotografi, disegni, viaggi? Geo-POPlitica è un progetto collettivo; siamo alla ricerca di persone curiose da ogni angolo del mondo. Parlaci di te, mostraci qualcosa di quello che fai tramite un link al tuo sito, blog o account social pubblico (non usare allegati) e facci sapere cosa ti piacerebbe realizzare.</p>
          <p style="font-family:'Playfair Display',serif;font-size:1rem;line-height:1.8;color:var(--ink);opacity:0.75;margin-bottom:16px">Collaboriamo per passione e non per compenso, ma ci teniamo a farlo bene. Ci prendiamo il tempo di leggere tutto quello che riceviamo. Se sentiamo di avere il posto giusto per un tuo progetto inedito, ti scriviamo.</p>
